    ...
    public function setUp(): void
    {
        ...
        $this->prepareDatabase([
            ...
            'polls' => [
                ...
                ['id' => 1, 'question' => 'Active poll no end', 'subtitle' => null, 'image' => null, 'image_alt' => null, 'post_id' => null, 'user_id' => 1, 'public_poll' => 0, 'end_date' => null, 'created_at' => '2025-01-01 00:00:00', 'updated_at' => '2025-01-01 00:00:00', 'vote_count' => 0, 'allow_multiple_votes' => 0, 'max_votes' => 0, 'published_at' => '2026-01-01 00:00:00', 'settings' => '{"max_votes": 0,"hide_votes": false,"public_poll": false,"allow_change_vote": false,"allow_multiple_votes": false}'],
                // Poll 2: Active — end date in the future
                ['id' => 2, 'question' => 'Active poll future end', 'subtitle' => null, 'image' => null, 'image_alt' => null, 'post_id' => null, 'user_id' => 1, 'public_poll' => 0, 'end_date' => '2030-01-01 00:00:00', 'created_at' => '2025-01-02 00:00:00', 'updated_at' => '2025-01-02 00:00:00', 'vote_count' => 0, 'allow_multiple_votes' => 0, 'max_votes' => 0, 'published_at' => '2026-01-01 00:00:00', 'settings' => '{"max_votes": 0,"hide_votes": false,"public_poll": false,"allow_change_vote": false,"allow_multiple_votes": false}'],
                // Poll 3: Ended — end date in the past
                ['id' => 3, 'question' => 'Ended poll old', 'subtitle' => null, 'image' => null, 'image_alt' => null, 'post_id' => null, 'user_id' => 1, 'public_poll' => 0, 'end_date' => '2020-01-01 00:00:00', 'created_at' => '2025-01-03 00:00:00', 'updated_at' => '2025-01-03 00:00:00', 'vote_count' => 0, 'allow_multiple_votes' => 0, 'max_votes' => 0, 'published_at' => '2026-01-01 00:00:00', 'settings' => '{"max_votes": 0,"hide_votes": false,"public_poll": false,"allow_change_vote": false,"allow_multiple_votes": false}'],
                // Poll 4: Ended — end date in the past (more recent)
                ['id' => 4, 'question' => 'Ended poll recent', 'subtitle' => null, 'image' => null, 'image_alt' => null, 'post_id' => null, 'user_id' => 1, 'public_poll' => 0, 'end_date' => '2021-06-01 00:00:00', 'created_at' => '2025-01-04 00:00:00', 'updated_at' => '2025-01-04 00:00:00', 'vote_count' => 0, 'allow_multiple_votes' => 0, 'max_votes' => 0, 'published_at' => '2026-01-01 00:00:00', 'settings' => '{"max_votes": 0,"hide_votes": false,"public_poll": false,"allow_change_vote": false,"allow_multiple_votes": false}'],
            ],
            'poll_options' => [
