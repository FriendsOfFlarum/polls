...
class CreatePollDraftTest extends TestCase
{
    ...
    #[Test]
    public function createDraftPersistsNullPublishedAt(): void
    {
        $response = $this->send(
    ...
    #[Test]
    public function createDraftAllowsMissingOptions(): void
    {
        $response = $this->send(
            $this->request('POST', '/api/polls', [
                'authenticatedAs' => 3,
    ...
    #[Test]
    public function createNonDraftSetsPublishedAt(): void
    {
        $response = $this->send(
            $this->request('POST', '/api/polls', [
                'authenticatedAs' => 3,
    ...
    #[Test]
    public function createDiscussionPollRejectsIsDraftTrue(): void
    {
        $response = $this->send(
            $this->request('POST', '/api/polls', [
                'authenticatedAs' => 3,
