...
/* harmony import */ var flarum_components_Badge__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! flarum/components/Badge */ "flarum/components/Badge");
/* harmony import */ var flarum_components_Badge__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(flarum_components_Badge__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_models_Discussion__WEBPACK_IMPORTED_MODULE_3___default.a.prototype, 'badges', function (badges) {
    if (this.poll()) {
      badges.add('poll', flarum_components_Badge__WEBPACK_IMPORTED_MODULE_1___default.a.component({
        type: 'poll',
...
/* harmony import */ var _components_CreatePollModal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/CreatePollModal */ "./src/forum/components/CreatePollModal.js");



/* harmony default export */ __webpack_exports__["default"] = (function () {
  flarum_components_DiscussionComposer__WEBPACK_IMPORTED_MODULE_1___default.a.prototype.addPoll = function () {
    var _this = this;

    app.modal.show(_components_CreatePollModal__WEBPACK_IMPORTED_MODULE_2__["default"], {
      poll: this.poll,
  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_DiscussionComposer__WEBPACK_IMPORTED_MODULE_1___default.a.prototype, 'headerItems', function (items) {
    if (app.session.user.canStartPolls()) {
      items.add('polls', m("a", {
        ...
        className: "PollLabel " + (this.poll ? '' : 'none')
      }, app.translator.trans("fof-polls.forum.composer_discussion." + (this.poll ? 'edit' : 'add') + "_poll"))), 1);
    }
  });
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_utils_PostControls__WEBPACK_IMPORTED_MODULE_1___default.a, 'moderationControls', function (items, post) {
    ...
    if (!poll.hasEnded()) {
      items.add('fof-polls-edit', flarum_components_Button__WEBPACK_IMPORTED_MODULE_2___default.a.component({
        icon: 'fas fa-check-square',
        onclick: function onclick() {
          return app.modal.show(_components_EditPollModal__WEBPACK_IMPORTED_MODULE_3__["default"], {
            poll: poll
          });
        }
    ...
    items.add('fof-polls-remove', flarum_components_Button__WEBPACK_IMPORTED_MODULE_2___default.a.component({
      icon: 'fas fa-trash',
      onclick: function onclick() {
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_CommentPost__WEBPACK_IMPORTED_MODULE_1___default.a.prototype, 'oncreate', function (context) {
    var _this = this;

    if (app.pusher) {
      app.pusher.then(function (channels) {
        channels.main.bind('newPollVote', function (data) {
          var userId = parseInt(data['user_id']);
          if (userId == app.session.user.id()) return;
          var poll = app.store.getById('polls', _this.attrs.post.discussion().poll().id());

          if (parseInt(poll.id()) === parseInt(data['poll_id'])) {
            var vote = {};
            Object.keys(data).map(function (key) {
              vote[key] = flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_2___default()(data[key]);
            });
            vote['option'] = flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_2___default()(app.store.getById('poll_options', data['option_id']));
            vote['user'] = Steram(app.store.getById('users', data['user_id']));
            var newVotes = poll.votes();
            newVotes.some(function (vote, i) {
              if (parseInt(vote.user().id()) === userId) {
                newVotes.splice(i, 1);
              }
            });
            newVotes.push(vote);
            poll.votes = flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_2___default()(newVotes);
            m.redraw.sync();
          }
        });
        Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(context, 'onunload', function () {
          return channels.main.unbind('newPollVote');
        });
      });
    }
  });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CreatePollModal; });
...
/*#__PURE__*/
function (_Modal) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(CreatePollModal, _Modal);
  ...
  _proto.oninit = function oninit(vnode) {
    ...
    this.options = [flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_4___default()(''), flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_4___default()('')];
    this.question = flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_4___default()('');
    this.endDate = flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_4___default()();
    this.publicPoll = flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_4___default()(false);

    if (this.props.poll) {
      var poll = this.attrs.poll;
      this.options = poll.relationships.options.map(function (o) {
        return flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_4___default()(o);
      });
  ...
  _proto.configDatePicker = function configDatePicker(vnode) {
    ...
    flatpickr__WEBPACK_IMPORTED_MODULE_5___default()(vnode.dom, {
      enableTime: true,
  ...
  _proto.content = function content() {
    return [m("div", {
      ...
      className: "label"
    }, app.translator.trans('fof-polls.forum.modal.question_placeholder')), m("input", {
      type: "text",
      name: "question",
    ...
    }, m("span", null, app.translator.trans('fof-polls.forum.modal.options_label')), flarum_components_Button__WEBPACK_IMPORTED_MODULE_1___default.a.component({
      className: 'Button PollModal--button small',
      icon: 'fas fa-plus',
      onclick: this.addOption.bind(this)
    })), this.displayOptions()), m("div", {
      className: "Form-group"
    }, m("label", {
      className: "label"
    }, app.translator.trans('fof-polls.forum.modal.date_placeholder')), m("div", {
    ...
    }, app.translator.trans('fof-polls.forum.modal.public_poll_label'))), m("div", {
      className: "Form-group"
    }, flarum_components_Button__WEBPACK_IMPORTED_MODULE_1___default.a.component({
      type: 'submit',
  ...
  _proto.displayOptions = function displayOptions() {
    ...
    return Object.keys(this.options).map(function (el, i) {
      return m("div", {
        className: _this2.options[i + 1] === '' ? 'Form-group hide' : 'Form-group'
      }, m("fieldset", {
        ...
        type: "text",
        name: 'answer' + (i + 1),
        bidi: _this2.options[i],
        placeholder: app.translator.trans('fof-polls.forum.modal.option_placeholder') + ' #' + (i + 1)
      })), i >= 2 ? flarum_components_Button__WEBPACK_IMPORTED_MODULE_1___default.a.component({
        type: 'button',
  ...
  _proto.addOption = function addOption() {
    var setting = app.data['fof-polls.options.max'];
    var max = setting && parseInt(setting) || 11;

    if (this.options.length < max) {
      this.options.push(flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_4___default()(''));
    } else {
  ...
  _proto.onsubmit = function onsubmit(e) {
    ...
    var options = this.options.map(function (a) {
      return a();
    }).filter(Boolean);
...
/* harmony import */ var _ListVotersModal__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./ListVotersModal */ "./src/forum/components/ListVotersModal.js");
...
/*#__PURE__*/
function (_Component) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_1__["default"])(PollVote, _Component);
  ...
  _proto.oninit = function oninit(vnode) {
    ...
    this.vote = flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_5___default()();
    this.voted = flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_5___default()(false);
    this.updateData();
  };
  ...
  _proto.view = function view() {
    ...
    return m("div", null, m("h3", null, this.poll.question()), this.options.map(function (opt) {
      var hasVoted = _this.voted();

      var voted = _this.vote() && _this.vote().option().id() === opt.id();

      var votes = _this.votes.filter(function (v) {
        return v.option().id() === opt.id();
      }).length;

      var percent = Math.round(votes / _this.poll.votes().length * 100);
      var attrs = voted ? {
        title: hasVoted && app.translator.transChoice('fof-polls.forum.tooltip.votes', votes, {
          count: String(votes)
        }).join(''),
      ...
      var inputAttrs = voted ? {
        checked: true
      } : {};
      return m("div", {
        className: "PollOption " + (hasVoted && 'PollVoted') + " " + (_this.poll.hasEnded() && 'PollEnded')
      }, m("div", Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, attrs, {
        className: "PollBar",
        "data-selected": voted
      }), (!_this.poll.hasEnded() && app.session.user && app.session.user.canVotePolls() || !app.session.user) && m("label", {
        className: "checkbox"
      }, m("input", Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({
        onchange: _this.changeVote.bind(_this, opt),
        type: "checkbox"
      }, inputAttrs)), m("span", {
        className: "checkmark"
      })), m("div", {
        style: hasVoted && '--width: ' + percent + '%',
        className: "PollOption-active"
      }), m("label", {
        className: "PollAnswer"
      }, m("span", null, opt.answer())), hasVoted && m("label", null, m("span", {
        className: percent !== 100 ? 'PollPercent PollPercent--option' : 'PollPercent'
      }, percent, "%"))));
    }), m("div", {
      style: "clear: both;"
    }), this.poll.publicPoll() ? flarum_components_Button__WEBPACK_IMPORTED_MODULE_3___default.a.component({
      className: 'Button Button--primary PublicPollButton',
      onclick: function onclick() {
        return _this.showVoters();
      }
    }, app.translator.trans('fof-polls.forum.public_poll')) : '', app.session.user && !app.session.user.canVotePolls() ? m("div", {
      className: "helpText PollInfoText"
    }, app.translator.trans('fof-polls.forum.no_permission')) : this.poll.hasEnded() ? m("div", {
      className: "helpText PollInfoText"
    }, app.translator.trans('fof-polls.forum.poll_ended')) : this.poll.endDate() !== null ? m("div", {
      className: "helpText PollInfoText"
    }, m("i", {
      "class": "icon fa fa-clock-o"
    }), app.translator.trans('fof-polls.forum.days_remaining', {
  ...
  _proto.updateData = function updateData() {
    ...
    this.vote(app.session.user ? this.votes.find(function (v) {
      return v.user() && v.user().id() === app.session.user.id();
    }) : null);
  ...
  _proto.changeVote = function changeVote(option, evt) {
    ...
    app.request({
      ...
      if (!option) app.store.remove(_this2.vote());
  ...
  _proto.showVoters = function showVoters() {
    app.modal.show(_ListVotersModal__WEBPACK_IMPORTED_MODULE_6__["default"], {
      poll: this.poll
    });
  };
...
/* harmony import */ var flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! flarum/utils/Stream */ "flarum/utils/Stream");
/* harmony import */ var flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _CreatePollModal__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./CreatePollModal */ "./src/forum/components/CreatePollModal.js");
...
var EditPollModal =
/*#__PURE__*/
function (_CreatePollModal) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(EditPollModal, _CreatePollModal);
  ...
  _proto.init = function init() {
    ...
    this.optionAnswers = this.options.map(function (o) {
      return flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_2___default()(o.answer());
    });
    this.question = flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_2___default()(this.poll.question());
    this.endDate = flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_2___default()(this.poll.endDate());
    this.publicPoll = flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_2___default()(this.poll.publicPoll());
  };
  ...
  _proto.addOption = function addOption() {
    ...
    if (this.options.length < max) {
      ...
      this.optionAnswers.push(flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_2___default()(''));
    } else {
      alert(app.translator.trans('fof-polls.forum.modal.max'));
    }
  };
...
}(_CreatePollModal__WEBPACK_IMPORTED_MODULE_3__["default"]);
...
function (_Modal) {
  ...
  _proto.content = function content() {
    ...
    }, this.attrs.poll.options().map(function (opt) {
      var votes = _this.props.poll.votes().filter(function (v) {
        return opt.id() === v.option().id();
      }).map(function (v) {
        return v.user();
      });

      return m("div", null, m("h2", null, opt.answer() + ':'), votes.length ? votes.map(function (u) {
        var attrs = u && {
          href: app.route.user(u),
          config: m.route
        };
        return m("li", null, m("a", attrs, flarum_helpers_avatar__WEBPACK_IMPORTED_MODULE_2___default()(u), " ", flarum_helpers_username__WEBPACK_IMPORTED_MODULE_3___default()(u)));
      }) : m("h4", {
        style: "color: #000"
...
/* harmony import */ var _models_Poll__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./models/Poll */ "./src/forum/models/Poll.js");
/* harmony import */ var _models_PollOption__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./models/PollOption */ "./src/forum/models/PollOption.js");
/* harmony import */ var _models_PollVote__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./models/PollVote */ "./src/forum/models/PollVote.js");
/* harmony import */ var _addDiscussionBadge__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./addDiscussionBadge */ "./src/forum/addDiscussionBadge.js");
/* harmony import */ var _addDiscussionComposerItem__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./addDiscussionComposerItem */ "./src/forum/addDiscussionComposerItem.js");
/* harmony import */ var _addPollToDiscussion__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./addPollToDiscussion */ "./src/forum/addPollToDiscussion.js");
/* harmony import */ var _addDiscussionControls__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./addDiscussionControls */ "./src/forum/addDiscussionControls.js");
...
app.initializers.add('fof/polls', function () {
  app.store.models.polls = _models_Poll__WEBPACK_IMPORTED_MODULE_1__["default"];
  app.store.models.poll_options = _models_PollOption__WEBPACK_IMPORTED_MODULE_2__["default"];
  app.store.models.poll_votes = _models_PollVote__WEBPACK_IMPORTED_MODULE_3__["default"];
  app.store.models.discussions.prototype.poll = flarum_Model__WEBPACK_IMPORTED_MODULE_0___default.a.hasOne('poll');
  app.store.models.users.prototype.canEditPolls = flarum_Model__WEBPACK_IMPORTED_MODULE_0___default.a.attribute('canEditPolls');
  app.store.models.users.prototype.canStartPolls = flarum_Model__WEBPACK_IMPORTED_MODULE_0___default.a.attribute('canStartPolls');
  app.store.models.users.prototype.canSelfEditPolls = flarum_Model__WEBPACK_IMPORTED_MODULE_0___default.a.attribute('canSelfEditPolls');
  app.store.models.users.prototype.canVotePolls = flarum_Model__WEBPACK_IMPORTED_MODULE_0___default.a.attribute('canVotePolls');
  Object(_addDiscussionBadge__WEBPACK_IMPORTED_MODULE_4__["default"])();
  Object(_addDiscussionControls__WEBPACK_IMPORTED_MODULE_7__["default"])();
  Object(_addDiscussionComposerItem__WEBPACK_IMPORTED_MODULE_5__["default"])();
  Object(_addPollToDiscussion__WEBPACK_IMPORTED_MODULE_6__["default"])();
});
...
/*#__PURE__*/
function (_mixin) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(Poll, _mixin);
  ...
  hasEnded: flarum_Model__WEBPACK_IMPORTED_MODULE_1___default.a.attribute('hasEnded'),
  endDate: flarum_Model__WEBPACK_IMPORTED_MODULE_1___default.a.attribute('endDate'),
  publicPoll: flarum_Model__WEBPACK_IMPORTED_MODULE_1___default.a.attribute('publicPoll'),
  options: flarum_Model__WEBPACK_IMPORTED_MODULE_1___default.a.hasMany('options'),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return PollOption; });
/* harmony import */ var _babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/esm/inheritsLoose */ "./node_modules/@babel/runtime/helpers/esm/inheritsLoose.js");
/* harmony import */ var flarum_Model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! flarum/Model */ "flarum/Model");
/* harmony import */ var flarum_Model__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(flarum_Model__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var flarum_utils_mixin__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! flarum/utils/mixin */ "flarum/utils/mixin");
...
/*#__PURE__*/
function (_mixin) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(PollOption, _mixin);
  ...
  poll: flarum_Model__WEBPACK_IMPORTED_MODULE_1___default.a.hasOne('polls'),
  votes: flarum_Model__WEBPACK_IMPORTED_MODULE_1___default.a.hasMany('votes')
}));
...
/*#__PURE__*/
function (_mixin) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(PollVote, _mixin);
  ...
  poll: flarum_Model__WEBPACK_IMPORTED_MODULE_1___default.a.hasOne('poll'),
  option: flarum_Model__WEBPACK_IMPORTED_MODULE_1___default.a.hasOne('option'),
  user: flarum_Model__WEBPACK_IMPORTED_MODULE_1___default.a.hasOne('user'),
  pollId: flarum_Model__WEBPACK_IMPORTED_MODULE_1___default.a.attribute('pollId'),
  optionId: flarum_Model__WEBPACK_IMPORTED_MODULE_1___default.a.attribute('optionId')
}));
