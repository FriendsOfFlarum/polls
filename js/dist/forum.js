...
var PollOption = /*#__PURE__*/function (_Component) {
  ...
  _proto.view = function view() {
    ...
    }, this.state.showCheckMarks && m("label", {
  ...
  _proto.displayOptions = function displayOptions() {
    ...
    this.options.forEach(function (option, i) {
      items.add('option-' + i, m("div", {
        ...
        className: "helpText"
      }, flarum_forum_app__WEBPACK_IMPORTED_MODULE_4___default().translator.trans('fof-polls.forum.modal.poll_option_image.help')), m(_UploadPollImageButton__WEBPACK_IMPORTED_MODULE_13__["default"], {
        ...
        value: _this2.optionImageUrls[i]()
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            } else if (_context.t0 instanceof (flarum_common_utils_RequestError__WEBPACK_IMPORTED_MODULE_15___default())) {
...
var PollPageHero = /*#__PURE__*/function (_Component) {
  ...
  (0,_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_0__["default"])(PollPageHero, [{
    ...
    key: "title",
    get: function get() {
      return this.attrs.title || flarum_forum_app__WEBPACK_IMPORTED_MODULE_2___default().translator.trans('fof-polls.forum.polls_page.title');
    }
  }, {
    key: "icon",
    get: function get() {
...
var UploadPollImageButton = /*#__PURE__*/function (_Button) {
  ...
  _proto.getImageUrl = function getImageUrl() {
    var _this$attrs$poll, _this$attrs$option;
    if (this.uploadedImageUrl !== false) {
      return this.uploadedImageUrl;
    }
    return ((_this$attrs$poll = this.attrs.poll) == null ? void 0 : _this$attrs$poll.imageUrl()) || ((_this$attrs$option = this.attrs.option) == null ? void 0 : _this$attrs$option.imageUrl());
  }
