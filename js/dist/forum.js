...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  flarum_components_DiscussionComposer__WEBPACK_IMPORTED_MODULE_1___default.a.prototype.addPoll = function () {
    ...
    app.modal.show(new _components_CreatePollModal__WEBPACK_IMPORTED_MODULE_2__["default"]({
      poll: this.poll,
    ...
    if (!poll.hasEnded()) {
      items.add('fof-polls-edit', flarum_components_Button__WEBPACK_IMPORTED_MODULE_2___default.a.component({
        ...
        onclick: function onclick() {
          return app.modal.show(new _components_EditPollModal__WEBPACK_IMPORTED_MODULE_3__["default"]({
            poll: poll
          }));
        }
      }));
...
/* harmony import */ var _components_DiscussionPoll__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/DiscussionPoll */ "./src/forum/components/DiscussionPoll.js");
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_CommentPost__WEBPACK_IMPORTED_MODULE_1___default.a.prototype, 'content', function (content) {
    ...
    if (discussion.poll() && this.props.post.number() === 1) {
      content.push(_components_DiscussionPoll__WEBPACK_IMPORTED_MODULE_2__["default"].component({
...
function (_Modal) {
  ...
  _proto.configDatePicker = function configDatePicker(el, isInitialized) {
    ...
    flatpickr__WEBPACK_IMPORTED_MODULE_4___default()(el, {
      enableTime: true,
...
function (_Component) {
  ...
  _proto.view = function view() {
    ...
    return m("div", null, m("h3", null, this.poll.question()), this.options.map(function (opt) {
      ...
      return m("div", {
        className: "PollOption " + (hasVoted && 'PollVoted')
        ...
        style: !_this.poll.hasEnded() ? 'margin-left: 25px' : '',
    ...
    }) : '', app.session.user && !app.session.user.canVotePolls() ? m("div", {
  ...
  _proto.showVoters = function showVoters() {
    app.modal.show(new _ListVotersModal__WEBPACK_IMPORTED_MODULE_5__["default"]({
      poll: this.poll
    }));
  };
...
function (_Modal) {
  ...
  _proto.content = function content() {
    ...
    }, this.props.poll.options().map(function (opt) {
