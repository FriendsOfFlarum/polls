                        ...
                        return (
                            <div className="PollOption PollVoted">
                                <div
                                    title={
                                        item.votes() >= 1
                                            ? item.votes() + ' ' + app.translator.trans('reflar-polls.forum.tooltip.vote')
                                            : item.votes() + ' ' + app.translator.trans('reflar-polls.forum.tooltip.votes')
                                    }
                                    className="PollBar"
                                    data-selected={voted}
                                ...
                                >
                                    ...
                                    <label style={!this.poll.isEnded() ? 'margin-left: 25px' : ''} className="PollAnswer">
